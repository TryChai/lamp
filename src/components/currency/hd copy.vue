<template>
    <div class="drag" ref="dragDiv">
        ...
        <div ref="moveDiv" @touchstart="mousedownFn($event)" :class="{'handler_ok_bg':confirmSuccess}" class="handler handler_bg" style="position: absolute;top: 0px;left: 0px;">
            <!-- <van-icon name="arrow" color="red"  size="42"/> -->
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            successFunction(){
                ...
                this.$emit("is_yz",this.confirmSuccess)
            },                //验证成功函数
            ...
            moseUpFn(e){
                ...
                var bool=document.getElementsByClassName('handler');
                if(width<this.maxwidth && bool.length>0){
