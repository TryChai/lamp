  ...
  >
    <div class="coupon_box">
      ...
      <div class="coupon_content">
        <div class="coupon_body" v-if="da != 'null'">
          <div
            class="coupon_item"
            v-for="(item, i) in da"
            :key="i"
          ...
          >
            ...
            <div class="coupon_item_content">
              ...
              <div class="new_coupon_item_content_right" @click="receive">
                立即
                <br />领取
                <br />
...
export default {
  ...
  methods: {
    ...
    receive() {
      //领取归来或推荐红包
      this.$api.getPage.receiveRedEnvelopes({}).then((res) => {
        if (res.code == 200) {
  ...
  watch: {
    ...
    da(val1, val2) {
      ...
      console.log("000000999999999:", val1);
      var price = 0;
