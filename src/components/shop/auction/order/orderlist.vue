...
import orderItem from "@/components/shop/auction/item/auction_order_item.vue";
export default {
    data () {
        return {
    ...
    methods: {
        ...
        upCallback (page, mescroll) {
            ...
            this.$api.getShop.get_auctionOrder(params).then(res => {
                if (res.code == 200) {
                    let arr = res.result;
                    // 如果是第一页需手动置空列表
