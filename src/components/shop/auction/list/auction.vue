        ...
        <mescroll-vue ref="mescroll"
            ...
            <div class="presale_body">
                ...
                <div class="presale_box">
                    <div class="presale_box_item"
                        v-for="(item,k) in datalist"
                        :key="k">
                        <auction_item :info="item"></auction_item>
                    </div>
                </div>
            </div>
        </mescroll-vue>
...
<script>
import auction_item from "@/components/shop/auction/item/auction_shop_item";
...
export default {
    ...
    methods: {
        get_presale_banner () {
            this.$api.getConfig.get_iden({ iden: "auction_banner" }).then(res => {
                if (res.code == 200) {
