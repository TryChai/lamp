        ...
        <div class="show_detail_content">
            ...
            :initial-swipe="swipestart"
                ...
                <van-swipe-item style="height:100%;background:#000"
                    v-if="detail.shop_video && detail.shop_video != ''"
                    ...
                    <div>
                        ...
                        <img v-show="isVideoShow"
                            @click="playvideo"
                            :src="detail.shop_video_cover"
                            v-if="!$fnc.isYkAPP()"
                            class="play play1" />
                        <video-default class="video_box"
                            direction="vertical"
                            :url="detail.shop_video"
                            :video_pic="detail.shop_video_cover"
                            v-else />
                    </div>
                </van-swipe-item>
                <van-swipe-item v-for="(item, index) in detail.img_json"
                    :key="index"
                ...
                <div class="custom-indicator"
                    slot="indicator">
                    {{ swipestart + 1 }}/{{detail.shop_video && detail.shop_video != '' ? detail.img_json.length+1:detail.img_json.length}}
                </div>
            </van-swipe>
...
export default {
    ...
    methods: {
        ...
        onChange (index) {
            ...
            this.$emit('currency',index)
        },
        big_img (i) {
            var arr = [];
            this.detail.img_json.forEach((item) => {
