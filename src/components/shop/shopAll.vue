<template>
  <div class="searc_content" id="shop_con">
    <van-nav-bar left-text left-arrow class="navbar" :fixed="true" title="全部商品" @click-left="toBack">
      <van-icon name="search" color="#333333" size="24px" @click="$router.push('/shop/shopsearch')" slot="right" />
    </van-nav-bar>
